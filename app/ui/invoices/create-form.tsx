...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  const [state, dispatch] = useFormState(createInvoice, initialState); // https://react.dev/reference/react-dom/hooks/useFormState
  ...
  return (
    <form action={dispatch}>
          ...
          */}
          ...
          {/* https://nextjs.org/learn/dashboard-app/improving-accessibility#server-side-validation 
              ...
              - aria-live="polite": The screen reader should politely notify the user when the error inside the div is updated. 
                When the content changes (e.g. when a user corrects an error), the screen reader will announce these changes, but only 
                when the user is idle so as not to interrupt them.
          */}
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                // required  // you can use 'required' (among others, such as min="0" max="5000") for simpler client-side validation
      ...
      <div className="mt-6 flex justify-end gap-4" aria-describedby='form-error'>
